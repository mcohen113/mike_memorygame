...
console.log('Charlie\'s a bad ass and mike is too');
...
function isTwoCards() {
  ...
  if (this.getAttribute('data-card') === 'king') {
    this.innerHTML = "<img src='img/queen_m.png' class='m_img'>";// king
  } else {
    this.innerHTML = "<img src='img/king_m.png' class='m_img'>"; //queen
  }
